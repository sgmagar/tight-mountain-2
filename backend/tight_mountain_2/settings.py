"""
Django settings for tight_mountain_2 project.
...
ROOT_URLCONF = 'tight_mountain_2.urls'
...
WSGI_APPLICATION = 'tight_mountain_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tight_mountain_2 API",
    "DESCRIPTION": "API documentation for tight_mountain_2 App",
    "VERSION": "v1",
}
